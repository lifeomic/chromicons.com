    ...
    >
      ...
      >
        ...
        <button
          ...
          className="absolute -top-16 -right-12 text-white rounded-full p-2 duration-300 transition-shadow  focus:outline-none focus-visible:shadow-dark-mode-outline"
          onClick={onDismiss}
        >
